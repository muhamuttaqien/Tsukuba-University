...
from utils import to_torchdim, frame2tensor, encode_feedback_nav, encode_feedback_nav_for_pickup, encode_feedback_pickup
...
class DQNAgent():
    ...
    def reallocate_agent(self, controller):
    ...
    def watch(self, controller, agent_name, floor_id, action_space):
        ...
        while True:
            ...
            self.reallocate_agent(controller)
